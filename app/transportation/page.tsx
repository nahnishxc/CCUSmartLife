...
export default function Transportation() {
  ...
  return (
    <div className="w-full h-full bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-gray-100 flex flex-col overflow-y-auto custom-scrollbar">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-10">
        ...
        >
          ...
          <div className="mb-4 relative z-10">
            <h3 className="text-lg font-bold text-gray-800 leading-tight mb-1">CCU Activity Center</h3>
        ...
        >
          ...
          <div className="mb-3 relative z-10 flex justify-between items-center">
            <h3 className="text-lg font-bold text-gray-800">Minxiong Station</h3>
            ...
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-gray-100">
                ...
                <tr>
                  ...
                  <td className="p-2 text-right font-mono text-gray-800">14:28</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <div className="mt-10">
        <h3 className="text-lg font-bold text-gray-800 mb-4">Frequently Used Routes</h3>
        <div className="flex gap-5 overflow-x-auto pb-6 px-1 custom-scrollbar">
          {Object.values(ROUTE_DATA).map((route) => (
            ...
            >
              <div
                className={`w-full aspect-square ${route.imageColor} rounded-2xl mb-3 flex items-center justify-center text-gray-400/50 font-bold group-hover:scale-[1.02] transition-transform shadow-sm`}
              >
                IMG
              </div>
