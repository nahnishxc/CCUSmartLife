      ...
      <div className="bg-gray-50/80 p-4 md:p-5 rounded-2xl border border-gray-100 mb-8 flex-shrink-0 shadow-sm">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end gap-3 md:gap-4">
          ...
          <button 
            ...
            className="w-full lg:w-auto mt-1 lg:mt-0 h-12 px-8 bg-emerald-600 text-white rounded-xl font-black text-sm md:text-base hover:bg-emerald-700 shadow-md shadow-emerald-200/50 transition-transform active:scale-95 flex items-center justify-center gap-2 disabled:opacity-70 flex-shrink-0"
          >
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar pr-1">
        {isSearched ? (
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="pb-10">
            ...
            <div className="flex justify-between items-center mb-5 px-1">
              <h3 className="text-sm md:text-base font-black text-emerald-700 border-l-4 border-emerald-500 pl-3">
                Search Results
              </h3>
            </div>
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-8 pb-10">
            {quickCheckData.map((data, idx) => (
               <div key={idx}>
                  <h3 className="text-sm md:text-base font-black text-gray-700 mb-3 pl-1 flex items-center gap-2">
                     <div className="w-2 h-2 rounded-full bg-emerald-500"></div>
                     {data.station}
                  </h3>
                  ...
                  <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden shadow-sm">
                     <div className="grid grid-cols-12 bg-gray-50/80 text-[10px] md:text-xs font-bold text-gray-400 py-3 px-2 md:px-4 border-b border-gray-100 text-center uppercase tracking-wider">
                        ...
                        <div className="col-span-3">Type</div>
                        <div className="col-span-2">Time</div>
                        <div className="col-span-2 text-right pr-1 md:pr-2">Delay</div>
                     </div>
