...
export default function ProfileModal({ isOpen, onClose, userData }: ProfileModalProps) {
  ...
  const displayUsername = userData?.name || "User Name";
  const displayEmail = userData?.email || "student@ccu.edu.tw";
        ...
        <div className="fixed inset-0 z-[110] flex items-center justify-center font-sans">
          ...
          >
            ...
            <div className="flex flex-col items-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-gray-700">{displayUsername}</h2>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-[#D4D4D4] p-4 rounded-lg">
                <div className="text-xs font-bold text-gray-600 mb-1">Account</div>
                <div className="text-gray-800 font-medium">{displayEmail}</div>
              </div>
