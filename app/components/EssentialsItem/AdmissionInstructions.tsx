...
export default function AdmissionInstructions() {
  ...
  return (
    <div className="w-full h-full bg-white rounded-3xl p-6 md:p-10 shadow-sm border border-gray-100 flex flex-col">
      {/* 標題區 */}
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-gray-800">Information for Admission to CCU</h2>
        <p className="text-sm text-gray-500 mt-1">Essential skills and knowledge to become a student at Chung Cheng University.</p>
      </div>
