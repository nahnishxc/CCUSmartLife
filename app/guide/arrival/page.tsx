...
const FAQS: FaqItem[] = [
  {
    id: "a1",
    question:"What if my student visa is not ready before the semester starts? Can I enter Taiwan with a visitor visa?",
    answer: `If your Resident Visa is delayed, do not panic. Follow these steps:
Step 1: Contact your university
• Inform the O<ice of International A<airs (OIA) immediately
• Ask about registration deadlines or possible arrangements
Step 2: Check your visa status
• Contact the Taiwanese overseas o<ice (TECO) where you applied
• Confirm whether additional documents or an interview are required
※ Important: Entry status matters
1. If you enter visa-free or with a landing visa, you cannot change it to a student Resident Visa
inside Taiwan.
2. If you enter with a Visitor Visa for study purposes, you may apply for conversion to a
Resident Visa in Taiwan.
3. If your visa states “No Extension”, it normally cannot be extended or changed.`,
  },
  {
    ...
    answer: `When entering Taiwan, certain items are strictly controlled. Please check carefully before
departure.
1. Strictly Prohibited:
• Meat and meat products (especially pork products from ASF-a<ected countries)
• Illegal drugs
...
• NT 1,000 for payment after approval)
※ After approval, you will receive your ARC card, which serves as your o<icial residence ID in Taiwan.`,
  },
  {
    id: "a4",
...
※ Important Reminder: Starting an internship without a valid work permit may lead to legal
penalties. Always obtain approval before beginning any work.`,
  },
  {
    id: "a5",
...
※ Because temperatures may change between day and night, layered clothing is a practical
choice.`,
  },
  {
    id: "a6",
    question: "How do I travel from Taoyuan International Airport (or other airports) to CCU?",
...
you must declare it to customs.`,
  ...
  {
    id: "a8",
    question: "How can I get a SIM card in Taiwan? Can I buy one at the airport and use it long-term?",
    answer: `Yes, you can buy a SIM card at the airport. Major telecom providers have service counters upon
arrival.
...
• Di<icult or not possible to convert into long-term plans
...
• Unlimited data plans are common and a<ordable`,
  },
  {
    id: "a9",
    question: "What should I do after arriving on campus? When can I move into the dormitory?",
    answer: `If you are staying in a dormitory, you can move in after arriving at CCU. Dormitory check-in is the
5
...
4. Submit Required Documents: Go to the Division of Curriculum and Instruction in the
Administration Building to submit your documents.
...
4. Convenience Store (Cash): Bring an electronic or printed payment slip to a convenience store
and pay in cash.`,
  },
   {
    id: "a11",
    question: "1. How do I apply for an ARC? What documents are required and when should I apply?",
...
• Passport-sized photo (meeting o<icial requirements)
...
※ If You Apply Late
• You may be fined
• If you overstay your visa, you may face heavier penalties and possible departure from
Taiwan`,
  },
];
    ...
    <div className="w-full h-full bg-white rounded-3xl p-6 md:p-10 shadow-sm border border-gray-100 flex flex-col overflow-y-auto custom-scrollbar">
      ...
      <div className="mb-10 md:mb-12">
        ...
        <p className="pl-5 mt-4 text-base md:text-lg text-gray-500 leading-relaxed max-w-2xl">
          Pre-arrival preparation and registration. Search a keyword to quickly find the right answer.
        </p>
      </div>
