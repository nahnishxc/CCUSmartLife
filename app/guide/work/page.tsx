...
const FAQS: FaqItem[] = [
  {
    id: "w1",
    question:"Can international students work in Taiwan? Do I need a work permit and when can I start?",
    answer: `Yes, international students can work part-time in Taiwan while enrolled in a degree program — but
you must have a valid work permit first.
...
• You cannot begin working until the permit is o<icially approved
• You must already have your ARC to apply
Working without a valid work permit is illegal and may result in fines or a<ect your residency
status.
...
• All work must comply with Taiwan’s Labor Standards Act.`,
  },
  {
    ...
    answer: `You must apply online through the Ministry of Labor’s o<icial work permit system. You may apply
by yourself or ask the O<ice of International A<airs (OIA) for assistance.
...
If you want to continue working, you must reapply before the current permit expires.`,
  ...
  {
    id: "w3",
    question: "How many hours can I work per week? Are there restrictions on job types and minimum age?",
...
※ You may have more than one part-time job, but the total hours during the semester must not
exceed 20 hours.
2. Job Restrictions
...
※ About Private Tutoring: Private one-on-one tutoring without a registered employer is legally
risky and may be considered illegal. If you want to tutor, it is recommended to work through a
registered school or institution.
3. Minimum Wage: As of January 1, 2026, the minimum hourly wage in Taiwan is NT$196 per
hour, and the minimum monthly salary is NT$29,500.`,
  },
  {
    id: "w4",
    question: "Do I need a work permit for internships (on-campus or oZ-campus)?",
...
• Additional legal consequences`,
  },
  {
    ...
    answer: `Yes. International students can stay and work in Taiwan after graduation under current regulations
(e<ective January 1, 2026).
1. Job-Seeking ARC (Most Common Option)
After graduation, your student ARC will usually be cancelled.
You must apply for a Job-Seeking ARC at the National Immigration Agency before your ARC is
cancelled.
...
Once your employer receives a work permit from the Ministry of Labor, you must change your
status to an Employment ARC.
3. Other Options
...
• Employment-Seeking Visa (if you leave Taiwan and later return to look for work)`,
  },
  {
    ...
    answer: `Yes. CCU provides career counseling and job search support for international students through
the O<ice of International A<airs (OIA).
    ...
    <div className="w-full h-full bg-white rounded-3xl p-6 md:p-10 shadow-sm border border-gray-100 flex flex-col overflow-y-auto custom-scrollbar">
      ...
      <div className="mb-10 md:mb-12">
        ...
        <p className="pl-5 mt-4 text-base md:text-lg text-gray-500 leading-relaxed max-w-2xl">
          Work, career, and internships. Search a keyword to quickly find the right answer.
        </p>
      </div>
