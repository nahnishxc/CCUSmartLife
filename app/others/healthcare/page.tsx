...
//       <div className="absolute top-[60%] -translate-y-1/2 left-0 z-10 opacity-0 group-hover/row:opacity-100 transition-opacity pointer-events-none">
//         <button 
//           onClick={() => scroll("left")}
//           className="pointer-events-auto w-10 h-10 rounded-full bg-white/90 shadow-md border border-gray-100 flex items-center justify-center text-gray-600 hover:text-emerald-600 transition-all -ml-3"
//         >
//           <ChevronLeft size={24} />
//         </button>
//       </div>

//       <div className="absolute top-[60%] -translate-y-1/2 right-0 z-10 opacity-0 group-hover/row:opacity-100 transition-opacity pointer-events-none">
//         <button 
//           onClick={() => scroll("right")}
//           className="pointer-events-auto w-10 h-10 rounded-full bg-white/90 shadow-md border border-gray-100 flex items-center justify-center text-gray-600 hover:text-emerald-600 transition-all -mr-3"
//         >
